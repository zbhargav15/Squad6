  ...
  BFHSelectBox.prototype = {
    ...
    initSelectBox: function () {
      ...
      if (this.options.filter === true) {
        this.$element.find('.bfh-selectbox-options').prepend('<div class="bfh-selectbox-filter-container"><input type="text" name="event_date" class="bfh-selectbox-filter form-control"></div>');
      }
